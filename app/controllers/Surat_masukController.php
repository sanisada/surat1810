...
class Surat_masukController extends SecureController{
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("surat_masuk.Nomor", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Nomor","Tanggal_Terima","Tanggal_Surat","Asal_Surat","Penerima","Nomor_Surat","Ringkasan_Isi_Surat","Keterangan");
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("surat_masuk.Nomor", $rec_id);;
	...
	function delete($rec_id = null){
		...
		$db->where("surat_masuk.Nomor", $arr_rec_id, "in");

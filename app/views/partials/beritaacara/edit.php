            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("beritaacara/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Nomor"  value="<?php  echo $data['Nomor']; ?>" type="number" placeholder="Enter Nomor" step="1"  required="" name="Nomor"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-Ringkasan_Isi"  value="<?php  echo $data['Ringkasan_Isi']; ?>" type="text" placeholder="Enter Ringkasan Isi"  required="" name="Ringkasan_Isi"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-No_Berita_Acara"  value="<?php  echo $data['No_Berita_Acara']; ?>" type="text" placeholder="Enter No Berita Acara"  required="" name="No_Berita_Acara"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

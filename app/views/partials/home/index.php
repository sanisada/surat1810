        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-3">
                    <h2 class="dashboard-title"><?php echo SITE_NAME ?></h2><br/><br/>
                    <h4 class="dashboard-title"><?php echo 'JUMLAH SURAT' ?></h4>
                </div>
            ...
            <div class="col-md-12 text-center mb-3">
                <h4 class="dashboard-title"><?php echo 'JUMLAH SURAT TUGAS BERDASARKAN TIM KERJA' ?></h4>
            </div>
            <div class="row">
                <?php
                $tim_counts = $comp_model->getcount_bytim(); // Memanggil fungsi model untuk mendapatkan data count
                foreach ($tim_counts as $tim) {
                    ?>
                    <div class="col-md-3 col-sm-6 mb-3">
                        <a class="record-count card bg-light text-dark" href="<?php print_link("surat_tugas/?tim=" . urlencode($tim['Nama_Tim_Kerja'])) ?>">
                            <div class="text-center p-3">
                                <div class="icon">
                                    <i class="fa fa-users fa-3x mb-3"></i>
                                </div>
                                <div class="title">
                                    <h5><?php echo $tim['Nama_Tim_Kerja']; ?></h5>
                                </div>
                                <div class="value">
                                    <strong><?php echo $tim['num']; ?></strong>
                                </div>
                            </div>
                        </a>
                    </div>

                                ...
                                <div class="form-group ">
                                    <div class="row">
                                     ...
                                     <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="ctrl-Tanggal_Terima">Tanggal Terima <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-Tanggal_Terima" class="form-control" type="date" value="<?php  echo $data['Tanggal_Terima']; ?>" name="Tanggal_Terima" required="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <!-- <a  class="btn btn btn-primary my-1" href="<?php print_link("surat_tugas/add") ?>">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <!-- <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-Nama_Yang_di_Tugaskan">
                                                        <span  data-value="<?php echo $data['Nama_Yang_di_Tugaskan']; ?>" 
                                                            data-pk="<?php echo $data['Nomor'] ?>" 
                                                            data-url="<?php print_link("surat_tugas/editfield/" . urlencode($data['Nomor'])); ?>" 
                                                            data-name="Nama_Yang_di_Tugaskan" 
                                                            data-title="Enter Nama Yang Di Tugaskan" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-Rentang_Waktu_Penugasan">
                                                        <span  data-value="<?php echo $data['Rentang_Waktu_Penugasan']; ?>" 
                                                            data-pk="<?php echo $data['Nomor'] ?>" 
                                                            data-url="<?php print_link("surat_tugas/editfield/" . urlencode($data['Nomor'])); ?>" 
                                                            data-name="Rentang_Waktu_Penugasan" 
                                                            data-title="Enter Rentang Waktu Penugasan" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <?php
                                                        ...
                                                        if (USER_ROLE === 'Admin') {
                                                            ...
                                                            <th class="td-btn">
                                                                ...
                                                                <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("surat_tugas/edit/$rec_id"); ?>">
                                                                    <i class="fa fa-edit"></i> Edit
                                                                </a>
                                                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("surat_tugas/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
        ...
        <div class="modal-content">
            ...
            <form action="<?php print_link("surat_tugas/tambah?csrf_token=$csrf_token") ?>" method="post">
                <div class="modal-body">
                    <label for="jenis"><h6>Keperluan Kegiatan</h6></label><br/>
                    <select name="jenis" id="jenis" class="custom-select custom-select-md mb-3">

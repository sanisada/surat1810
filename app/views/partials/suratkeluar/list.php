                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Ringkasan_Isi_Surat"> Ringkasan Isi Surat</th>
                                                ...
                                                <!-- <th class=" td-checkbox">
                                                    ...
                                                    <?php
                                                        ...
                                                        if (USER_ROLE === 'Admin') {
                                                            ?>
                                                           <th class="td-btn">
                                                               <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("suratkeluar/view/$rec_id"); ?>">

...
$(document).ready(function() {
	...
	$('#ctrl-Kode_Klasifikasi').hide();
$("label[for='Kode_Klasifikasi']").hide();
$('#ctrl-Subkode_Klasifikasi').hide();
...
$('#ctrl-Jenis_Kegiatan').on('input',function(){
    if($('#ctrl-Jenis_Kegiatan').val() == "Klasifikasi"){
        $('#ctrl-Kode_Klasifikasi').show();
        $("label[for='Kode_Klasifikasi']").show();
         $('#ctrl-Subkode_Klasifikasi').show();
...
$('#ctrl-Jenis_Kegiatan').on('change', function(){
    if($('#ctrl-Jenis_Kegiatan').val() == "Klasifikasi"){
        $('#ctrl-Kode_Klasifikasi').show();
        $("label[for='Kode_Klasifikasi']").show();
        $('#ctrl-Subkode_Klasifikasi').show();
...
$('#ctrl-Kode_Sensus').hide();
$("label[for='Kode_Sensus']").hide();
...
$('#ctrl-Jenis_Kegiatan').on('input',function(){
    if($('#ctrl-Jenis_Kegiatan').val() == "Survei Sensus"){
        $('#ctrl-Kode_Sensus').show();
        $("label[for='Kode_Sensus']").show();
         $('#ctrl-Subkode_Sensus').show();
